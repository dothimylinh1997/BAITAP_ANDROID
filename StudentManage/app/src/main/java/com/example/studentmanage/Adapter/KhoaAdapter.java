...
import com.example.studentmanage.Activity.MainActivity;
...
public class KhoaAdapter extends BaseAdapter {
    ...
    public KhoaAdapter(MainActivity context, int layout, List<Khoa> khoaList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            holder.txtMaKhoa    = (TextView)view.findViewById(R.id.textviewMaKhoa);
            holder.txtTenKhoa   = (TextView)view.findViewById(R.id.textviewTenKhoa);
