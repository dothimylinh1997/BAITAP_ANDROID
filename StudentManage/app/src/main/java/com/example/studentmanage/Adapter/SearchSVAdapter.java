...
public class SearchSVAdapter extends BaseAdapter {
    private SearchSinhVien context;
    private int layout;
    private List<SinhVien> sinhVienList;

    public SearchSVAdapter(SearchSinhVien context, int layout, List<SinhVien> sinhVienList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        SearchSVAdapter.ViewHolder holder;
        if(view == null){
            holder = new SearchSVAdapter.ViewHolder();
            ...
            holder = (SearchSVAdapter.ViewHolder) view.getTag();
        }
