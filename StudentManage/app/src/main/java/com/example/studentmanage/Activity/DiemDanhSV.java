...
public class DiemDanhSV extends AppCompatActivity {
    ...
    String url = ActivityLogin.url + "quanlysinhvien/public/api/addDiemDanh";
    TextView txtTesst2;
    ListView lvDsSV;
    Button btnXong;
    public static ArrayList<SinhVienDiemDanh> arraySinhVien;
    DsDiemDanhSVAdapter adapter;
    String maLop;
    String maMH;
    String ngay;
    String newdataArray;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diem_danh_sv);
        setControl();
        ...
        adapter = new DsDiemDanhSVAdapter(this, R.layout.item_sinhvien2, arraySinhVien);
        ...
        lvDsSV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(DiemDanhSV.this, position+"-", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    void setControl(){
        lvDsSV = findViewById(R.id.listviewDsSV);
        txtTesst2  = findViewById(R.id.tesst2) ;
        btnXong = findViewById(R.id.buttonDiemDanhSv) ;
    }
                ...
                public void onResponse(String response1) {
                    try {
                        ...
                        for (int i = 0; i < array.length(); i++){
                            ...
                            arraySinhVien.add(new SinhVienDiemDanh(
    ...
    private void PostData(String url){
        for(SinhVienDiemDanh s: arraySinhVien)
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.toString().equals("Thành công")){
                            startActivity(new Intent(DiemDanhSV.this, ActivityDiemDanh.class));
                        }else {
                            Toast.makeText(DiemDanhSV.this, response.toString(), Toast.LENGTH_LONG).show();
                        }
