...
public class UpdateLop extends AppCompatActivity {
    ...
    String   urlUpdate = ActivityLogin.url + "quanlysinhvien/public/api/updateLop";
...
//        Toast.makeText(this, khoa.getTenKhoa(), Toast.LENGTH_SHORT).show();
    ...
    private void AnhXa() {
        btnCapNhap = (Button) findViewById(R.id.buttonOkLopUpdate);
        btnHuy     = (Button) findViewById(R.id.buttonHuyLopUpdate);
        edtMaLop   = (EditText) findViewById(R.id.edittextMaLopUpdate);
        edtTenLop  = (EditText) findViewById(R.id.edittextTenLopUpdate);
        edtMaKhoa  = (EditText) findViewById(R.id.edittextMaKhoaLopUpdate);
